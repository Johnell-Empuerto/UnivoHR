...
router.get("/hr-view", authenticate, authorize([ROLES.ADMIN, ROLES.HR_ADMIN]), controller.getHrView);

router.post("/assign", authenticate, authorize([ROLES.ADMIN, ROLES.HR_ADMIN]), controller.assign);
router.post("/bulk-assign", authenticate, authorize([ROLES.ADMIN, ROLES.HR_ADMIN]), controller.bulkAssign);
...
router.post("/:id/approve", authenticate, authorize([ROLES.ADMIN, ROLES.HR_ADMIN]), controller.hrApprove);
router.post("/:id/reject", authenticate, authorize([ROLES.ADMIN, ROLES.HR_ADMIN]), controller.hrReject);
