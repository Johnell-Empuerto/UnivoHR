jest.mock("../models/applicantEducation.model", () => ({
...
const { getByApplicantId, create, update, remove } = require("../services/applicantEducation.service");

describe("applicantEducation.service", () => {
  beforeEach(() => { jest.clearAllMocks(); });

  describe("getByApplicantId", () => {
    it("returns education records for applicant", async () => {
  ...
  describe("create", () => {
    it("creates for existing applicant", async () => {
      ...
      expect(await create({ applicant_id: 1, school_name: "MIT" })).toBeDefined();
    });
  ...
  describe("update", () => {
    it("updates existing record", async () => {
      ...
      await expect(update(1, { school_name: "Updated" })).resolves.toBeDefined();
    });
