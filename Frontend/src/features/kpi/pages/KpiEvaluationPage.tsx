...
const KpiEvaluationPage = () => {
  ...
  useEffect(() => { fetchEvaluations(); }, [page, search, statusFilter]);

  const fetchEvaluations = async () => {
    try { setLoading(true); const r = await getKpiHrView(search, statusFilter, page, 10); setEvaluations(r.data); setTotal(r.total); }
